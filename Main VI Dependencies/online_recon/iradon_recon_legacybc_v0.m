function [IR_crop, proj_mag_crop_bc, theta] = iradon_recon_legacybc(cropramppts,num_proj,RXmag,RXphase,angles,LPF_cut,enable_2nd_bc)
%UNTITLED4 Summary of this function goes here
%   Detailed explanation goes here
%%%% baseline correction used here uses the mean(first 4 pts of each) averaged over all angles 
